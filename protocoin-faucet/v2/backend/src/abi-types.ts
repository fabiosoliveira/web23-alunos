...
export interface Abi {
   ...
   */
  setMintAmount(newAmount: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   * Type: function
   * @param delayInSeconds Type: uint64, Indexed: false
   */
  setMintDelay(delayInSeconds: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
