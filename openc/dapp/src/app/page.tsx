        ...
        <section className="bg-secondary-500 poster pt-4 relative text-opacity-60 text-white sm:px-4">
          ...
          <div className="container mx-auto relative">
            <nav className="flex flex-wrap items-center px-4 py-2">
              ...
              <a
                href="#"
                className="font-bold gap-2 hover:text-gray-300 inline-flex items-center leading-none mr-4 text-3xl text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 34.142 40"
                  width="1.5em"
                  height="1.5em"
                  fill="currentColor"
                >
                  <path
                    data-name="Path 7167"
                    d="M20 40a20.005 20.005 0 0 1-7.785-38.428 19.983 19.983 0 0 1 21.927 4.286L29.895 10.1a14 14 0 1 0 0 19.79l4.247 4.247A19.937 19.937 0 0 1 20 40Z"
                  />
                  <path
                    data-name="Path 7168"
                    d="M20 14a6 6 0 1 1-6 6 6 6 0 0 1 6-6Z"
                  />
                </svg>
                <span className="uppercase">OpenC</span>
              </a>
              <button
              ...
              >
                <div className="flex flex-col ml-auto lg:flex-row">
                  ...
                  <a
                    href="/"
                    className="font-medium hover:text-gray-300 py-2 text-opacity-60 text-white lg:p-4 xl:px-6"
                  >
                    Home
                  </a>
                  <a
                ...
                <a
                  href="#"
                  className="bg-gradient-to-t bg-primary-500 font-bold from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block px-6 py-2 rounded text-white to-primary-400"
                >
                  My NFTs
                </a>
              </div>
      ...
      <footer className="bg-secondary-500 text-gray-400 sm:px-4">
        <div className="container mx-auto pt-12 px-4 relative">
          <div className="-mx-4 flex flex-wrap gap-6 items-end mb-12">
            <div className="px-4 w-full lg:w-6/12 xl:w-5/12">
              <h2 className="font-bold mb-4 text-2xl text-white">
            ...
            <div className="px-4 w-full lg:w-auto ml-auto">
              <div className="flex-wrap gap-2 inline-flex sm:gap-4">
                ...
                <a
                  href="#"
                  className="bg-gradient-to-t bg-primary-500 from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block p-3 rounded-full text-white to-primary-400"
                  aria-label="facebook"
                >
                  {" "}
                  <svg
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full p-4 xl:w-4/12">
              ...
              <p className="font-light mb-4">
                ...
                Fusce et porttitor libero, eu aliquam nisi. Nam finibus
                ullamcorper semper. Fusce et porttitor libero, eu aliquam nisi.
                Nam finibus ullamcorper semper.
              </p>
            </div>
            <div className="p-4 w-full sm:w-6/12 lg:w-4/12 xl:w-2/12">
              <h2 className="font-bold mb-6 text-primary-500 text-xl">
                {" "}
                About{" "}
              </h2>
              <ul>
          ...
          <div className="py-4">
            ...
            <div className="flex flex-wrap -mx-4  items-center">
              ...
              <div className="px-4 py-2 w-full sm:w-auto">
                {" "}
                <a href="#" className="hover:text-primary-600 text-primary-500">
                  Privacy Policy
                </a>{" "}
                |{" "}
                <a href="#" className="hover:text-primary-600 text-primary-500">
