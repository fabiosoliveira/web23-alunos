          ...
          <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
            <div className="px-4 py-5 flex-auto">
              ...
              <p className="mt-2 mb-4 text-gray-600">
                You&apos;ll have access to our private comminity at Telegram,
                with hundreds of developers helping each other.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-4/12 px-4 text-center">
          <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
            <div className="px-4 py-5 flex-auto">
              ...
              <p className="mt-2 mb-4 text-gray-600">
                You&apos;ll be enrolled in an web3 full course named Web23, that
                will improve your web2 skills and reach new levels.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-center mt-32">
        <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
          ...
          <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
            ...
            I&apos;m working to give more exclusive experiences and content to
            our community.
          </p>
